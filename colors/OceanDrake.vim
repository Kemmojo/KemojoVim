...
"}}}
" {{{ Colors
  let s:base00=['#1b2b34', '235']   " #1b2b34 
  let s:base01=['#343d46', '237']   " #343d46
  let s:base02=['#4f5b66', '240']   " #4f5b66
  let s:base03=['#65737e', '243']   " #65737e
  let s:base04=['#a7adba', '145']   " #a7adba
  let s:base05=['#c0c5ce', '251']   " #c0c5ce
  let s:base06=['#cdd3de', '252']   " #cdd3de
  let s:base07=['#d8dee9', '253']   " #d8dee9
  let s:base08=['#ec5f67', '203']   " #ec5f67:203
  let s:base09=['#f99157', '209']   " #f99157
  let s:base0A=['#ffaf5f', '215']   " #fac863:221 #ffaf5f:215
  ...
  let s:base11=['#5fd7ff', '81']    " #5fd7ff:81
  let s:base12=['#5f5faf', '61']    " #5f5faf:61
  let s:base13=['#5fffaf', '85']    " #5fffaf:85
  let s:base14=['#d75f00', '166']   " #d75f00:166
...
call <sid>hi('EndOfBuffer',                s:base05, '', '',          '')
...
call <sid>hi('Todo',                       s:base13, s:base01, '',          '')
