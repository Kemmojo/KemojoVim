...
" autocmd FileType c,cpp,java,go,php,javascript,puppet,python,rust,twig,xml,yml,perl,sql autocmd BufWritePre <buffer> if !exists('g:kemojovim_keep_trailing_whitespace') | call StripTrailingWhitespace() | endif
...
" autocmd BufNewFile,BufRead *.bundles,*.KemojoVim.local,*.KemojoVim.project,*.KemojoVim.Project set filetype=vim
" autocmd BufNewFile *.KemojoVim.project,*.KemojoVim.Project,*.KemojoVim.local 0r $kemojovim_root/.KemojoVim.project.sample
