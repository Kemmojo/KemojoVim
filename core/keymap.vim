...
" if !exists('g:kemojovim_leader')
"     let mapleader = ','
" else
"     let mapleader=g:kemojovim_leader
" endif
" if !exists('g:kemojovim_localleader')
"     let maplocalleader = '\'
" else
"     let maplocalleader=g:kemojovim_localleader
" endif
"
" " The default mappings for editing and applying the KemojoVim configuration
" " are <leader>ev and <leader>sv respectively. Change them to your preference
" " by adding the following to your .vimrc.before.local file:
" "   let g:kemojovim_edit_config_mapping='<leader>ec'
" "   let g:kemojovim_apply_config_mapping='<leader>sc'
" if !exists('g:kemojovim_edit_config_mapping')
"     let s:kemojovim_edit_config_mapping = '<leader>ec'
" else
"     let s:kemojovim_edit_config_mapping = g:kemojovim_edit_config_mapping
" endif
" if !exists('g:kemojovim_apply_config_mapping')
"     let s:kemojovim_apply_config_mapping = '<leader>ac'
" else
"     let s:kemojovim_apply_config_mapping = g:kemojovim_apply_config_mapping
" endif
"
" " TODO: edit config not working yet
" execute "noremap " . s:kemojovim_edit_config_mapping " :call EditKemojoVimConfig()<CR>"
" execute "noremap " . s:kemojovim_apply_config_mapping . " :source ~/.KemojoVim/vimrc<CR>"
"
" " Easier moving in tabs and windows
" " The lines conflict with the default digraph mapping of <C-K>
" " If you prefer that functionality, add the following to your
" " .vimrc.before.local file:
" "   let g:kemojovim_easyWindows = 1
" if !exists('g:kemojovim_no_easyWindows')
"     map <C-J> <C-W>j
"     map <C-K> <C-W>k
"     map <C-L> <C-W>l
"     map <C-H> <C-W>h
...
" if !exists('g:kemojovim_no_wrapRelMotion')
...
" if !exists('g:kemojovim_no_fastTabs')
"     map <S-H> gT
"     map <S-L> gt
" endif
"
" " Stupid shift key fixes
" if !exists('g:kemojovim_no_keyfixes')
...
" if exists('g:kemojovim_clear_search_highlight')
